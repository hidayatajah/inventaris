                ...
                <form action="{{ route('admin.user.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control   @error('nama_barang') is-invalid @enderror" name="nama_barang" value="{{ $data->nama_barang }}" placeholder="Masukkan nama barang">
                            @error('nama_barang')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control  @error('kategori') is-invalid @enderror" name="kategori">
                                <option selected disabled hidden value="">Pilih kategori produk</option>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" value="{{ $data->stok }}" class="form-control @error('stok') is-invalid @enderror" name="stok"  placeholder="Masukkan jumlah barang">
                            @error('stok')
                            <div class="invalid-feedback">
                               <small>{{ $message }}</small> </div>
                            @enderror
